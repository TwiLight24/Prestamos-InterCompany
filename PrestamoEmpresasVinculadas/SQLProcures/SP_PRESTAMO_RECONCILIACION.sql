CREATE OR ALTER PROCEDURE [dbo].[SP_PRESTAMO_RECONCILIACION] @PRESTAMO NVARCHAR(20), @BANCO NVARCHAR(20)
AS
BEGIN	
	...
	WHERE T0.DocNum = @PRESTAMO
	AND T4.Account = @BANCO
	AND T1.AcctCode = '171201' /* CUENTA DE PRESTAMOS */
	AND T0.Canceled = 'N'
	UNION
	SELECT T0.TransId, T4.Line_ID, IIF(ISNULL(T0.DocCurr,'SOL') = 'SOL', T1.SumApplied, T1.AppliedFC) Monto 

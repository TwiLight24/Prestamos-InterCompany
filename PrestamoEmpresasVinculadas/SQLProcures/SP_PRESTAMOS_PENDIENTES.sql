CREATE OR ALTER PROCEDURE SP_PRESTAMOS_PENDIENTES @MONEDA NVARCHAR(100), @EMPRESA_ACREEDORA NVARCHAR(200), @EMPRESA_DEUDORA NVARCHAR(200)
AS
BEGIN
	...
	--	WHERE CAST(DOCDATE AS DATE) >= '2025-07-30' AND T1.AcctCode = '471003'
	...
	--SELECT 
	--	DocEntry, DocNum, [Fecha Prestamo], [Comentario Prestamo], Moneda, CAST(MontoPrestamo AS DECIMAL(16,2)) MontoPrestamo, CAST((MontoPrestamo - Acumulado) AS DECIMAL(16,2)) Saldo
	--FROM (
	--	SELECT T0.DocEntry, 
	--		   T0.DocNum, 
	...
	--	WHERE CAST(T0.DOCDATE AS DATE) >= '2025-07-30' AND T1.AcctCode = '171201'
	--		AND T0.DocType = 'A' AND T0.Canceled = 'N'
	--		AND T0.DoccuRr = @MONEDA
	--)XTABLE
